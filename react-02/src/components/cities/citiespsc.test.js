...
test("test which sphere a city is in", () => {
    let cityInst = new psc.city(1, "Calgary", 51.05, -114.05, 1000)
    expect(cityInst.whichSphere()).toBe("Northern Hemisphere")
    let cityInst2 = new psc.city(1, "Rio de Janeiro", -22.91, -43.17, 6476631)
    expect(cityInst2.whichSphere()).toBe("Southern Hemisphere")
})
...
test("test getMostNorthern method in community class", () => {
    ...
    expect(communityInst.getMostNorthern()).toEqual("Calgary")
    communityInst.createCity("Edmonton", 53.55, -113.49, 800000)
    expect(communityInst.getMostNorthern()).toEqual("Edmonton")
})
...
test("test getMostSouthern method in community class", () => {
    ...
    communityInst.createCity("Calgary", 51.05, -114.05, 1500000)
    communityInst.createCity("Edmonton", 53.55, -113.49, 800000)
    expect(communityInst.getMostSouthern()).toEqual("Calgary")
    communityInst.createCity("Rio de Janeiro", -22.91, -43.17, 6476631)
    expect(communityInst.getMostSouthern()).toEqual("Rio de Janeiro")
})
