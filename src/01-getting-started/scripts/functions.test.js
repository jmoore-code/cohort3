...
test("Does the add to array work?", () => {
    expect(functions.addToArray(1)).toBe("The number 1 has been added to the array");
    expect(functions.addToArray(0)).toBe("The number 0 has been added to the array");
    expect(functions.addToArray(9)).toBe("The number 9 has been added to the array");
